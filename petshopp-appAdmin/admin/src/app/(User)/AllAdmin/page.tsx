    ...
    const fetchAdmin = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5000/api/v1/admin/details",
          ...
          <div className="w-full h-screen bg-white ">
            ...
            {admin.length === 0 ? (
              ...
              admin.map((a) => (
                <div
                  key={a._id}
                  className="flex items-center justify-center gap-2 border-1 border-y-teal-900 relative h-16 shadow-xl border-shadow hover:bg-gray-50 transition-all duration-200"
                >
                  ...
                  <p
                    className="hover:translate-y-1 cursor-pointer absolute right-0"
                    onClick={() => {
                      handlerRemove(a._id);
                    }}
                  >

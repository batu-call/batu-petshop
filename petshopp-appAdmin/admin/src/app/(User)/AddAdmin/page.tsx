            ...
            <Box display="flex" flexDirection="column" gap={3} width="100%">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <TextField
                  ...
                  variant="standard"
                  fullWidth
                  InputLabelProps={{ style: { color: "#B1CBBB" } }}
              ...
              {/* PHOTO */}
              <Box display="flex" alignItems="center" gap={3} mt={4} p={2} border="1px solid #eee" borderRadius={2}>
                <div className="relative cursor-pointer w-24 h-24 rounded-full border-2 border-dashed flex items-center justify-center overflow-hidden">
                  {file ? (
                    <Image
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">JPG or PNG supported</p>
                </div>
              </Box>

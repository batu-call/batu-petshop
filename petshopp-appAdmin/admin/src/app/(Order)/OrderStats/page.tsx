...
export default function OrderStats() {
  const { data, loading, mounted } = useOrderStats();
  ...
  if (!data) {
    return <div className="ml-40 mt-10 text-gray-500 dark:text-[#7aab8a]">No order stats found.</div>;
  }
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-white to-[#97cba9]/5 dark:from-[#0d1f18] dark:via-[#0d1f18] dark:to-[#162820] p-8">
      ...
      <MonthlyOrdersChart monthlyStats={data.monthlyStats} mounted={mounted} />

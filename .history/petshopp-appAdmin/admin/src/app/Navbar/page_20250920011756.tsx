...
const page = () => {
  return (
    <div>
      ...
      {/* Dropdown */}
      <div className="absolute left-0 hidden group-hover:block mt-1 w-48 bg-white shadow-lg rounded-xl z-10 hover:block">
        <ul className="flex flex-col">
          <li className='absolute hidden group-hover:block'>

  ...
  return (
    <div>
      ...
      <div className="group relative">
        ...
        {/* Dropdown */}
        <div className="absolute left-0  group-hover:block mt-1 w-50 bg-white shadow-lg rounded-xl z-10">
          <ul className="flex flex-col">
            <li>
           
                <a className="block px-4 py-2 hover:bg-gray-200 border-secondary border-b-2">All Users</a>
         
            </li>
            <li>
             
                <a className="block px-4 py-2 hover:bg-gray-200 border-secondary border-b-2">User Activity</a>

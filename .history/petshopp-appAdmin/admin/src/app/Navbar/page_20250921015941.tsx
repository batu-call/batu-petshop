...
const Page = () => {
  ...
  {/* Dropdown */}
  <div className="absolute left-0 mt-2 hidden group-hover:block w-48 bg-white shadow-lg rounded-xl z-50">
    <ul className="flex flex-col">
      <li>
        <Link
          href="/AddProduct"
          className="block px-4 py-2 hover:bg-gray-200 border-b border-secondary"
        >
          Add Product
        </Link>
      </li>

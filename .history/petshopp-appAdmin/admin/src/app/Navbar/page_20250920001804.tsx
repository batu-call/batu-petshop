  ...
  return (
    <div>
      ...
      <div className='flex gap-20 items-center justify-center absolute right-20'>
        ...
        <div className='bg-amber-50 w-50 h-7 rounded-xl bg-secondary'>
        <h3 className='items-center flex justify-center text-color text-jost'>Product</h3>
        </div>
        <div className='bg-amber-50 w-50 h-7 rounded-xl bg-secondary'>
        <h3 className='items-center flex justify-center text-color text-jost'>Order;lnkasf</h3>
        </div>
      </div>
    </div>
  )

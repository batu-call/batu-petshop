  ...
  return (
    <div>
      ...
      <div className='ml-120'>
        <Button className='absolute cursor-pointer bg-secondary text-color w-40 text-base'>Login</Button>
      </div>

      </div>
      <div className='flex gap-20 items-center justify-center absolute right-20'>
        <div className='w-50 h-7 rounded-xl bg-secondary'>
        <h3 className='items-center flex justify-center text-color text-jost text-base'>Users</h3>
        </div>
        <div className='w-50 h-7 rounded-xl bg-secondary'>
        <h3 className='items-center flex justify-center text-color text-jost text-base'>Products</h3>
        </div>
        <div className='w-50 h-7 rounded-xl bg-secondary'>

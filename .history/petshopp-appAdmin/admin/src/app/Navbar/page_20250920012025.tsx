  ...
  return (
    <div>
      ...
      <div className="group relative">
        <div className="w-60 h-7 rounded-xl bg-secondary flex items-center justify-center cursor-pointer">
          <h3 className="text-color text-jost">Users</h3>
        </div>

        {/* Dropdown */}
        <div className="absolute left-0 hidden group-hover:block mt-1 w-48 bg-white shadow-lg rounded-xl z-10">

...
const Main = () => {
  return (
    <div className='w-full h-screen bg-primary'>
      {/* Navbar */}
      <div className='w-full h-30 bg-white shadow-xl'>
      <div>
        <Image  src={"/logo.png"} alt='main-icon' width={500} height={500} className='flex justify-center items-center w-120 h-120'/>
      </div>
      </div>
      <div className='w-40 h-screen bg-white fixed mt-10'>
        {/* Cat */}
        <Link href={"/Cat"}>

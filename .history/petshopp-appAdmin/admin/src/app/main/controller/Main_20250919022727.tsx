...
const Main = () => {
  return (
    <div className='w-full h-screen bg-primary'>
      ...
      {/* Dog */}
       <div className='bg-primary inline-block p-2 items-center mt-6 ml-6 rounded-2xl'>
        <div className='flex gap-3 items-center justify-center'>
      ...
      {/* Reptile */}
       <div className='bg-primary inline-block p-2 items-center mt-6 ml-3 rounded-2xl w-120'>
        <div className='flex gap-3 items-center justify-center'>

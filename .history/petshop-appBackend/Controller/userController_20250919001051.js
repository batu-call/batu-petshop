...
import bcrypt from 'bcrypt'
    ...
    export const newAdmin = catchAsyncError(async(req,res,next)=>{
        ...
        const {firstName,lastName,email,phone,password,address,avatar="https://images.pexels.com/photos/1851164/pexels-photo-1851164.jpeg",role="Admin"} = req.body;
  ...
  export const adminLogin = catchAsyncError(async (req, res, next) => {
    ...
    // Find admin
    const admin = await User.findOne({ email, role: 'Admin' }).select("+passowrd");

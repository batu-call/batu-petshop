    ...
    <>
      <div className="flex items-center justify-between mb-4 md:hidden">
        <div className="text-sm text-gray-700 dark:text-[#a8d4b8]">
          Showing{" "}
          <span className="text-color dark:text-[#a8d4b8]! font-bold">{displayCount}</span> of{" "}
          <span className="text-black dark:text-[#c8e6d0] font-bold">{totalProducts}</span> products
        </div>
...
export default AllProductMobileFilterBar;
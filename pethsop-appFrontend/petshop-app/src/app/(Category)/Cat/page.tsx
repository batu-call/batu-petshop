    ...
    <>
      ...
      <div className="ml-0 md:ml-32 lg:ml-40 flex-1 flex items-center justify-center min-h-screen bg-white md:p-6 mt-3 md:mt-0">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 sm:gap-6 md:gap-6 lg:gap-8">
            {product.map((p) => (
              <Link
                key={p._id}
              ...
              >
                ...
                <div className="px-2 sm:px-4 py-1 sm:py-2 h-20 sm:h-24 md:h-28 overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row gap-2 justify-between items-center px-2 sm:px-4 py-2">
                  <h2 className="text-color text-sm sm:text-base xl:text-lg font-semibold">
                    {p.price},00$
                  </h2>
                  <Button
                    onClick={(e) => {

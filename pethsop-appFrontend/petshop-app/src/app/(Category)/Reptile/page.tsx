                ...
                <div className="flex flex-col sm:flex-row gap-2 justify-between items-center px-2 sm:px-4 py-2">
                 <div className="flex flex-col items-center mt-3">
                  {p.salePrice && p.salePrice < p.price ? (
                    ...
                    <span className="text-color text-sm sm:text-base xl:text-lg m-4 ml-3 font-semibold">
                      {p.price},00$
                    </span>
                  )}
                </div>
                  <Button
                    ...
                    className="sm:w-auto h-auto bg-secondary text-color cursor-pointer hover:bg-white text-sm sm:text-base m-4 transition-colors duration-400"
                  >
                    Add To Cart
                  </Button>
                </div>

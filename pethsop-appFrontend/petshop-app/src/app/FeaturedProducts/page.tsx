...
const FeaturedProducts = ({ reviewStats }: Props) => {
  ...
  return (
    <div className="flex-1 p-4">
      <div className="text-color dark:text-[#0b8457]! text-2xl sm:text-3xl lg:text-4xl font-bold flex items-center justify-center mb-2 sm:mb-8">
        <ScrollFloat
          animationDuration={1}
          ease="back.inOut(2)"
